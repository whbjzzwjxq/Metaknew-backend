    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Star', django.contrib.postgres.fields.ArrayField(base_field=models.UUIDField(), db_column='STAR', default=list, size=None)),
                ('CreateDoc', django.contrib.postgres.fields.ArrayField(base_field=models.UUIDField(), db_column='CREATE', default=list, size=None)),
                ('UploadSource', django.contrib.postgres.fields.ArrayField(base_field=models.UUIDField(), db_column='UPLOAD', default=list, size=None)),
            ],
            options={
